...
class ExcelReader extends Command
{
     ...
     * @var string
     */
    protected $signature = 'excel:reader {--drive=laravel-excel}';
     ...
     * @var string
     */
    protected $description = '测试excel与spout的性能';
    ...
    public function handle()
    {
        ...
        $path = 'public' . DIRECTORY_SEPARATOR . 'yili_memberinfo.xlsx';
    ...
    private function useSpoutDrive($path)
    {
        ...
        $reader->open(storage_path('app' . DIRECTORY_SEPARATOR .$path));
        $rows = [];
    ...
    private function useLaravelExcelDrive($path)
    {
        ...
        ini_set('memory_limit', -1);
        $array = Excel::toArray(new TestImport(), storage_path('app' . DIRECTORY_SEPARATOR .$path));
